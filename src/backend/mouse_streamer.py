...
class USBPassthroughAnalyzer(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        dev_logic_out_stream=dev_rx_boundary.processed_stream; m.d.comb+=arbiter.passthrough_in.stream_eq(dev_logic_out_stream); m.d.comb+=arbiter.inject_in.stream_eq(injector.source)
